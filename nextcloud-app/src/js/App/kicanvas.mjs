    ...
    st = class extends it {
        ...
        *list() {
        ...
        async get(e) {
            ...
            if (!n.ok)
                throw new Error(
                    `Unable to load ${r}: ${n.status} ${n.statusText}`,
                );
            let o = await n.blob();
            return new File([o], e);
        }
...
function un(s, t) {
    ...
    for (let i = 0; i < s.length - 1; i++)
        e.push(s[i]),
            t[i] instanceof j3 ? e.push(t[i].text) : e.push(`$$:${i}:$$`);
    ...
    apply_filter() {
        ue(() => {
            for (let t of this.items())
                this.#e == null ||
                t.dataset.matchText?.toLowerCase().includes(this.#e)
...
var U = class s {
    ...
    constructor(t) {
        if (t.length != 9)
            throw new Error(`Matrix3 requires 9 elements, got ${t}`);
...
var O = class s {
    ...
    contains_point(t) {
        return (
            t.x >= this.x && t.x <= this.x2 && t.y >= this.y && t.y <= this.y2
        );
    }
    constrain_point(t) {
    ...
    intersect_segment(t, e) {
        ...
        for (let p of [r, i, n, o]) {
            ...
            m &&
                m.sub(c).squared_magnitude < u.sub(c).squared_magnitude &&
                u.set(m);
        }
...
function Mn(s, t, e) {
    ...
    let f = p * m * (s.y - e.y),
        ...
        y =
            S *
            Math.sqrt(
                ((M / m) * M) / m + ((r / (s.x + t.x)) * r) / (s.x + t.x),
            ),
        v = p * (t.x + e.x),
        te =
            v *
            Math.sqrt(
                ((b / p) * b) / p + ((r / (t.x + e.x)) * r) / (t.x + e.x),
            ),
        X = 2 * (m - p),
...
function fn(s, t, e) {
    ...
    if (o !== 0) {
        switch (
            ((u = n === 0 || n === 1 ? 0 : (r - n) / Math.min(n, 1 - n)), r)
        ) {
            case s:
                c = (t - e) / o + (t < e ? 6 : 0);
                break;
            ...
            if (!this.#t) {
                let t = new O(
                    ...
                    e = U.translation(
                        this.at.position.x,
                        this.at.position.y,
                    ).rotate_self(W.deg_to_rad(this.at.rotation));
                for (let r of this.drawings)
                    r instanceof Ce ||
                        (t = O.combine([t, r.bbox.transform(e)]));
    ...
    z2 = class extends Qe {
        constructor(e, r) {
            ...
            if (n.angle !== void 0) {
                ...
                this.#e = z.from_three_points(n.start, n.mid, n.end, n.width);
...
var A = {
    ...
    me = class {
        ...
        update_hierarchical_data(t) {
            t ??= "";
            let e =
                    this.project?.root_schematic_page?.document
                        ?.symbol_instances,
            ...
            for (let o of this.sheets) {
                ...
                if (
                    u &&
                    ((o.page = u.page), (o.path = u.path), !o.instances.size)
                ) {
                    let p = new t3();
                    (p.page = u.page),
                        (p.path = u.path),
...
`) && (this.text = this.text.slice(0, this.text.length - 1));
    ...
    d2 = class extends ve {
        ...
        constructor(t) {
            super(),
                Object.assign(
                    this,
                    g(t, a.start("label"), ...ve.common_expr_defs),
                );
        }
    },
    m2 = class extends ve {
    ...
    Vt = class s {
        ...
        pin_by_number(t, e = 1) {
            ...
            throw new Error(
                `No pin numbered ${t} on library symbol ${this.name}`,
            );
        }
        ...
        get effects() {
            return this.#e
                ...
                : (this.parent instanceof re
                      ? (this.#e = new J())
                      : Bt(
                            `Couldn't determine Effects for Property ${this.name}`,
                        ),
                  this.#e);
        }
        set effects(t) {
    ...
    re = class {
        ...
        get lib_symbol() {
            return this.parent.lib_symbols.by_name(
                this.lib_name ?? this.lib_id,
            );
        }
        get_property_text(t) {
        ...
        resolve_text_var(t) {
            if (this.properties.has(t))
                return this.properties.get(t)?.shown_text;
            switch (t) {
                case "REFERENCE":
                    return this.reference;
                case "VALUE":
    ...
    c3 = class extends N {
        ...
        initialContentCallback() {
            this.renderRoot.addEventListener("input", (e) => {
                let r = e.target;
                r.name === "theme" &&
                    (g2.theme = Ze.by_name(this.theme_control.value)),
        ...
        super.initialContentCallback(),
            ...
            this.addDisposable(
                k(this.project, "change", (e) => {
                    this.selected =
                        this.project.active_page?.project_path ?? null;
                }),
            ),
...
var B = class {
    ...
    I = class s {
        ...
        static from_BBox(t, e) {
            return new s(
                [t.top_left, t.top_right, t.bottom_right, t.bottom_left],
                e,
            );
        }
    };
var Ke = class {
        ...
        prep_circle(t, e, r) {
            ...
            return (
                this.add_bbox(
                    O.from_points([i.center.add(n), i.center.sub(n)]),
                ),
                i
            );
        }
        ...
        prep_line(t, e, r) {
            ...
            t instanceof F
                ...
                : (i = new F(
                      t,
                      e ?? this.state.stroke_width,
                      r ?? this.state.stroke,
                  )),
                (!i.color || i.color.is_transparent_black) &&
                    (i.color = this.state.stroke ?? h.transparent_black),
                (i.points = Array.from(
                    this.state.matrix.transform_all(i.points),
                ));
        ...
        prep_polygon(t, e) {
            ...
            return (
                ...
                (r.points = Array.from(
                    this.state.matrix.transform_all(r.points),
                )),
...
function je(s, t) {
    ...
    do
        if (
            ((r = !1),
            !e.steiner && (h3(e, e.next) || w(e.prev, e, e.next) === 0))
        ) {
...
var ui = class {
    ...
    Tt = class s {
        ...
        static compile(t, e, r) {
            ...
            throw (
                (t.deleteShader(i),
                new Error(`Error compiling ${e} shader: ${n}`))
            );
        }
        static link(t, e, r) {
        ...
        #r() {
            ...
            for (
                ...
                (this.attribs[e.name] = e),
                    (this[e.name] = this.gl.getAttribLocation(
                        this.program,
                        e.name,
                    ));
            }
...
var ze = class {
    ...
    d3 = class s {
        constructor(t, e) {
            ...
            (this.shader = e ?? s.shader),
                (this.vao = new Lt(t)),
                (this.position_buf = this.vao.buffer(
    ...
    b3 = class s {
        ...
        set(t) {
            let e = 0;
            for (let u of t)
                ze.triangulate_polygon(u), (e += u.vertices?.length ?? 0);
            let r = e / 2,
                i = new Float32Array(e),
...
var Y = class s extends yt {
    ...
    get_text_as_glyphs(t, e, r, i, n, o, c) {
        ...
        if (
            (c.overbar
                ? ((te = !0),
                  (X.y = this.compute_overbar_vertical_position(y.y)))
                : c.underline &&
                  ((te = !0),
                  (X.y = this.compute_underline_vertical_position(y.y))),
            te)
        ) {
...
var $ = class {
    ...
    apply_effects(t) {
        (this.attributes.h_align = t.justify.horizontal),
            ...
            (this.attributes.stroke_width =
                this.get_effective_text_thickness(1588)),
...
`)),
        ...
        if (
            ...
            for (let y of n.slice(1))
                (M = u.get_line_extents(y, p, c, m, b)),
                    (V.x = Math.max(V.x, M.x));
...
var ae = class {
        ...
        *query_point(t) {
            for (let e of this.bboxes.values())
                e.contains_point(t) && (yield e);
        }
    },
    Ut = class {
        static {
        ...
        *interactive_layers() {
            for (let t of this.in_order())
                t.interactive && t.visible && (yield t);
        }
        *query_point(t) {
...
var O2 = new ce("kicanvas:project"),
    ...
    Ee = class {
        ...
        paint(t) {
            O2.debug("Painting"),
                O2.debug("Sorting paintable items into layers");
            for (let e of t.items()) {
                ...
                for (let i of r.layers_for(e))
                    this.layers.by_name(i)?.items.push(e);
            }
            for (let e of this.paintable_layers())
                O2.debug(
                    `Painting layer ${e.name} with ${e.items.length} items`,
                ),
                    this.paint_layer(e);
...
var _i = class extends be {
        ...
        paint(e, r) {
            ...
            for (let c = 0; c < r.repeat; c++) {
                ...
                if (!p || !m) return;
                this.gfx.line(
                    new F([p, m], r.linewidth || i.setup.linewidth, e.color),
                );
            }
        }
    },
    Mi = class extends be {
        ...
        paint(e, r) {
            ...
            (i.attributes.bold = r.font?.bold ?? !1),
                ...
                (i.attributes.size = (
                    r.font?.size ?? r.parent.setup.textsize
                ).multiply(1e4)),
...
var zs = 8,
    ...
    y3 = class {
        constructor(t, e, r, i = 0.5, n = 10, o) {
            ...
            this.max_zoom = n;
            this.bounds = o;
            this.target.addEventListener("wheel", (b) => this.#r(b), {
                passive: !1,
            });
            let c = null,
                u = null;
...
var F2 = class extends EventTarget {
    ...
    async setup() {
        (this.renderer = this.disposables.add(
            this.create_renderer(this.canvas),
        )),
                    ...
                    ue(async () => {
                        Je.info("Waiting for viewport"),
                            ...
                            (this.viewport.bounds =
                                this.drawing_sheet.page_bbox.grow(50)),
    ...
    constructor(e, r) {
        ...
        for (let n of Object.values(et)) {
            ...
            to.includes(n) &&
                ...
                (c = !0)),
                n == ":Pads:Front" &&
                    ((o = l(() => this.by_name("F.Cu").visible, "visible")),
                    (c = !0)),
                n == ":Pads:Back" &&
                    ((o = l(() => this.by_name("B.Cu").visible, "visible")),
                    (c = !0)),
                io(n) &&
                    ((c = !0),
                    this.add(
...
var j = class extends be {
        ...
        layers_for(e) {
            if (e.layers) {
                ...
                for (let i of rn(e.layers[0], e.layers[1]))
                    r.push(Te(i, "BBViaHoles")),
                        r.push(Te(i, "BBViaHoleWalls"));
                return r;
                ...
                : e.name.endsWith("Holes") &&
                  ...
                  (r.type == "blind" || r.type == "micro") &&
                      ...
                      (this.gfx.arc(
                          ...
                          r.size / 4,
                          e.layer_set.by_name(r.layers[0])?.color ??
                              h.transparent_black,
                      ),
                      this.gfx.arc(
                          r.at.position,
                          ...
                          W.from_degrees(180 - 70),
                          r.size / 4,
                          e.layer_set.by_name(r.layers[1])?.color ??
                              h.transparent_black,
                      )));
        }
    },
    Li = class extends j {
        ...
        paint(e, r) {
            if (
                r.filled_polygons &&
                !(this.filter_net && r.net != this.filter_net)
            )
            ...
            if (
                ...
                switch (
                    ...
                    case "trapezoid":
                        {
                            let p =
                                    Math.min(r.size.x, r.size.y) *
                                    (r.roundrect_rratio ?? 0),
                ...
                if (r.shape == "custom" && r.primitives)
                    for (let p of r.primitives)
                        this.view_painter.paint_item(e, p);
            }
            this.gfx.state.pop();
        }
    },
        ...
        paint_leader(e, r) {
            let i = r.style.thickness ?? 0.2,
                ...
                o = n
                    ...
                    .grow(
                        n.text_width / 2,
                        n.get_effective_text_thickness() * 2,
                    )
                    .scale(1 / 1e4),
                c = r.start.add(
                    r.end.sub(r.start).resize(r.style.extension_offset),
                ),
            ...
            if (
                ...
                r.style.text_frame == 1 &&
                    this.gfx.line(F.from_BBox(o, i, e.color)),
            ...
            this.gfx.line([c.add(S), c, c.add(V)], i, e.color),
                this.paint_text(n);
        }
        paint_linear(e, r) {
            let i = r.style.thickness ?? 0.2,
        ...
        this.addEventListener("kc-ui-menu:select", (e) => {
            ...
            this.addDisposable(
                this.viewer.addEventListener(D.type, () => {
                    this.menu.selected =
                        this.viewer.selected?.context.uuid ?? null;
                }),
            ),
                ...
                <kc-ui-panel-body>
                    <kc-ui-property-list>
                        ...
                        ${o(
                            ...
                            r.setup?.pad_to_mask_clearance ?? 0,
                            "mm",
                        )}
                        ${o(
                            "Soldermask min width",
                            r.setup?.solder_mask_min_width ?? 0,
                            "mm",
                        )}
                        ${o(
                            "Pad to paste clearance",
                            r.setup?.pad_to_paste_clearance ?? 0,
                            "mm",
                        )}
                        ${o(
                            "Pad to paste clearance ratio",
                            r.setup?.pad_to_paste_clearance_ratio ?? 0,
                        )}
                        ${o(
                            "Grid origin",
                            `${r.setup?.grid_origin?.x ?? 0}, ${
                                r.setup?.grid_origin?.y ?? 0
                            }`,
                        )}
                    </kc-ui-property-list>
                </kc-ui-panel-body>
            ...
            this.presets_menu.addEventListener("kc-ui-menu:select", (e) => {
                ...
                switch (r.name) {
                    ...
                    case "copper":
                        for (let n of i)
                            n.visible =
                                n.name.includes(".Cu") || n.name == "Edge.Cuts";
                        break;
                    case "outer-copper":
                        for (let n of i)
                            n.visible =
...
var Q3 = class extends Ke {
    ...
    Ki = class extends He {
        ...
        push_path(e, r, i, n) {
            ...
            o &&
            (o.path_count < 20,
            o.fill == r && o.stroke == i && o.stroke_width == n)
    ...
    vt = class extends Ut {
        constructor(e) {
            ...
            (this.by_name(":Interactive").visible = !1),
                ...
                (this.by_name(ke.drawing_sheet).color =
...
var v3 = class extends Ee {
    ...
    K = class extends be {
        ...
        determine_fill(e, r) {
            ...
            if (
                i == "none" ||
                (i == "background" && e.name != ":Symbol:Background")
            )
                return null;
            let n;
            switch (i) {
    ...
    Y3 = class extends w2 {
        ...
        get_schematic_text_offset(e, r) {
            ...
            switch (
                ...
                default:
                    throw new Error(
                        `Unexpected label rotation ${e.at.rotation}`,
                    );
            }
        }
        create_shape(e, r) {
...
var H3 = class s extends K {
    ...
    paint(e, r) {
        ...
        s.apply_symbol_transformations(i, n),
            ...
            e.name == ":Symbol:Foreground" &&
                this.draw_name_and_number(this.gfx, i),
            this.gfx.state.pop();
    }
            ...
            for (let n of r)
                if (!(n.style > 0 && i != n.style))
                    for (let o of n.drawings)
                        this.view_painter.paint_item(e, o);
        }
    },
    J3 = class extends K {
        constructor() {
        ...
        paint(e, r) {
            ...
            if (e.name == ":Symbol:Field" || e.name == ":Interactive")
                for (let [o, c] of r.properties)
                    this.view_painter.paint_item(e, c);
...
var Gi = class extends K {
    ...
    Ji = class extends K {
        ...
        paint(e, r) {
            this.gfx.line(
                new F(r.pts, this.gfx.state.stroke_width, this.theme.wire),
            );
        }
    },
    Ii = class extends K {
    ...
    ji = class extends K {
        ...
        paint(e, r) {
            ...
            let o = r.parent,
                u =
                    this.view_painter.current_symbol_transform?.matrix ??
                    U.identity(),
                p = r.shown_text;
    ...
    zi = class extends K {
        ...
        paint_debug(e) {
            this.gfx.line(
                F.from_BBox(e.scale(1 / 1e4), 0.127, new h(0, 0, 1, 1)),
            ),
                this.gfx.circle(
    ...
    qi = class extends K {
        ...
        paint(e, r) {
            ...
            if (
                ...
                e.name == ":Symbol:Background" &&
                    this.gfx.polygon(I.from_BBox(o, n)),
                e.name == ":Symbol:Foreground" &&
                    this.gfx.line(
                        F.from_BBox(o, this.gfx.state.stroke_width, i),
                    ),
                e.name == ":Symbol:Field")
            )
...
var I3 = class extends Ft {
    ...
    select(t) {
        if (
            (G(t) &&
                (t =
                    this.schematic.find_symbol(t) ??
                    this.schematic.find_sheet(t)),
            ...
            <kc-ui-panel>
                ...
                <kc-ui-panel-body>
                    <kc-ui-property-list>
                        ...
                        ${n(
                            "Unique symbols",
                            r.lib_symbols?.symbols.length ?? 0,
                        )}
...
var rs = class extends N {
    ...
    render() {
        ...
        if (!o) n = e("No item selected");
            ...
            let c = o.lib_symbol,
                u = Array.from(o.properties.values()).map((m) =>
                    r(m.name, m.text),
                ),
            ...
            let c = Array.from(o.properties.values()).map((p) =>
                    r(p.name, p.text),
                ),
